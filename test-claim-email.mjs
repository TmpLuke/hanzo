...
async function testClaimEmail() {
  console.log('📧 Sending test claim email...\n');
  ...
  const productName = 'PUBG Cheat';
  const variantLabel = '1 Week';
  const amount = 28.90;
...
<p style="margin:0;color:#555;font-size:13px">© 2024 Hanzo Marketplace</p>
  ...
  try {
    const info = await transporter.sendMail({
      ...
      subject: `✅ Order Confirmed - ${orderNumber} - Claim Your Product`,
      html: emailHtml,
    });
    ...
    console.log('   - Discord claim button');
    console.log('   - Order number for ticket');
  } catch (error) {
