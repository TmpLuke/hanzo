...
app.post('/api/send-email', async (req, res) => {
  try {
    const { orderNumber, customerEmail, customerName, productName, variantLabel, amount } = req.body;

    const GMAIL_USER = process.env.GMAIL_USER || 'petyaiscute@gmail.com';
    const GMAIL_APP_PASSWORD = process.env.GMAIL_APP_PASSWORD || 'bfmeghukdikgetkp';
...
<img src="https://i.postimg.cc/pVKR3vWT/Hanzo-AVI.png" alt="Hanzo" style="width:120px;height:auto;margin:0 auto 24px;display:block" />
...
<table width="100%"><tr><td style="padding:14px 0;border-bottom:1px solid #1f1f1f"><span style="color:#888;font-size:15px">Order Number</span></td><td align="right" style="padding:14px 0;border-bottom:1px solid #1f1f1f"><span style="color:#10b981;font-weight:700;font-family:monospace">${orderNumber}</span></td></tr>
<tr><td style="padding:14px 0;border-bottom:1px solid #1f1f1f"><span style="color:#888;font-size:15px">Product</span></td><td align="right" style="padding:14px 0;border-bottom:1px solid #1f1f1f"><span style="color:#fff;font-weight:600">${productName}</span></td></tr>
<tr><td style="padding:14px 0;border-bottom:1px solid #1f1f1f"><span style="color:#888;font-size:15px">Variant</span></td><td align="right" style="padding:14px 0;border-bottom:1px solid #1f1f1f"><span style="color:#fff">${variantLabel}</span></td></tr>
<tr><td style="padding:20px 0 0 0"><span style="color:#888;font-size:17px;font-weight:600">Total Paid</span></td><td align="right" style="padding:20px 0 0 0"><span style="color:#10b981;font-size:32px;font-weight:800">$${Number(amount).toFixed(2)}</span></td></tr>
</table></div>
...
<h3 style="margin:0 0 14px 0;color:#fff;font-size:19px;font-weight:700">🎮 How to Claim Your Product</h3>
<p style="margin:0 0 20px 0;color:rgba(255,255,255,0.85);font-size:15px;line-height:1.7">To receive your product key, please open a ticket in our Discord server with your order number: <strong style="color:#10b981">${orderNumber}</strong></p>
<div style="text-align:center">
<a href="https://discord.gg/hanzo" style="display:inline-block;background:#5865F2;color:white;text-decoration:none;padding:14px 32px;border-radius:10px;font-weight:700;font-size:15px">
<span style="display:inline-block;margin-right:8px">💬</span> Open Ticket on Discord
</a>
</div>
</div>
