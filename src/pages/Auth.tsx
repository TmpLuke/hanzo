      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <Link to="/" className="flex items-center gap-3 mb-8">
            <img src={hanzoLogo} alt="Hanzo" className="w-12 h-12 rounded-xl" />
            <span className="text-2xl font-display font-bold">Hanzo</span>
          </Link>
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center bg-card relative overflow-hidden">
        ...
        <div className="relative z-10 text-center p-8">
          ...
          <h2 className="text-4xl font-display font-bold mb-4">
            <span className="text-gradient">Elevate</span> Your Stream
          </h2>
          <p className="text-muted-foreground max-w-md">
            Access premium overlays, tools, and graphics designed to make your content stand out.
          </p>
        </div>
      </div>
    </div>
